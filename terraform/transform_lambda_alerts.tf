resource "aws_cloudwatch_log_metric_filter" "general_transform_error" {
  name           = "LambdaGeneralError"
  pattern        = "ERROR"
  log_group_name = "/aws/lambda/transform_sql_data"
...
resource "aws_cloudwatch_metric_alarm" "general_transform_error_alarm" {
